    ...
    return (
        <section>
            <div  >
                ...
                <div  style={{ height: '100%',margin:'-25px 0 0 0',background: 'rgba(143, 211, 244, 0.5)' }}>
                    <div className="container h-100" style={{ padding: '6%' }}>
                        <div className="row d-flex justify-content-center align-items-center h-100">
                            <div className="col-12 col-md-9 col-lg-7 col-xl-6">
                                <div style={{ margin: "-15px 0 0 -265px", width: '1000px', height: '650px',background:'white',borderRadius:'5px' }} >
                                    <div  style={{ height: '520px',padding:"5%" }} >
                                        <div style={{  marginTop: '-30px', borderRadius: '10px', width: '100%' }}>
                                            <h3 className="text-uppercase text-center mb-5" style={{ color: 'black' ,textDecoration:'underline',textDecorationStyle:''}}>Update Register Info</h3>
                                        </div>
                                        ...
                                        <div style={{ display: 'flex', gap: '20px' }}>
                                                ...
                                                <div >
                                                    <label style={{ margin: '15px 0 0 0 ', fontWeight: 'bold' }}>Discount</label>&#x25;
                                                    <input type='text' id='discount' name='discount' style={{ margin: '-40px 0 0 10px', borderRadius: '3px', outline: 'none' ,width:'40px',alignItems:'center'}}  onChange={handler} readOnly />&nbsp;
                                                </div>
                                                <div>
